# ========== v1.0 SIMPLE RETRIEVAL WITH NO RERANKING SYSTEM OR NER FILTERING ==========
...
# LLM_MODEL = "x-ai/grok-4.1-fast:free"  # or whatever model id you want on OpenRouter
...
# COLLECTION_NAME = "history_chunks_bge_large"  # use EXACT same name as in embed script

# MODEL_NAME = "BAAI/bge-large-en"

# K_RETRIEVE = 8  # how many chunks per query
...
#     use_jsonb=True,
#     pre_delete_collection=False,      # VERY IMPORTANT: don't drop existing data
# )


# def retrieve_chunks(query: str, k: int = K_RETRIEVE) -> List[Document]:
...
#         answer = answer_question(query, k=8)
#         print("\n=== ANSWER ===")
#         print(answer)
#         print("\n" + "=" * 80)
...
# ========== v2.0 HYBRID RETRIEVAL USING BM25 LEXICAL SEARCH AND RRF WITH NO NER FILTERING ==========
...
# def answer_question(query: str, k: int = K_RETRIEVE) -> str:
#     # 1) Retrieve
#     docs = retrieve_chunks_hybrid(query, k_final=k)
